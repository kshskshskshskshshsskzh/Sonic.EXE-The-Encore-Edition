...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	CoderName1 = 'denumu07'
	CoderName2 = 'rr2k07qt__'
	
	ArtistName1 = 'Sonic.exe Artist Team'
	
	MusicianName1 = 'goth9355'

	CharterName1 = 'denumu07'


	
--Script Options--

Start = 4 --choose which "STEP" to activate the script on

CreditsExitTimer = 4 --How many seconds the script will show before exiting

TweenSpeed = 1.2 --How fast the credits move in/out
